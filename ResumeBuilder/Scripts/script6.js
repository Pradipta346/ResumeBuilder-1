        ...
        if (item.SchoolName) {
            ...
            var eduHtml = `
                <div class="education-item">
                    <div class="degree"><b>${item.SchoolName}</b></div>
                    <div class="specialization">
                        ${item.EducationDegree}, ${item.Major}
                        <span class="dates">${item.City} | ${formattedstartdate} - ${formattedenddate}</span>
                    </div>
                    <div class="grade">${item.GPA}</div>
                    <div class="clear"></div>
                </div>
            `;
    ...
    experience.forEach(function (item) {
        if (item.PositionTitle) {
            ...
            <div class="experience-item">
                <div class="role">${item.EmployerName}</div>
                <div class="department">${item.PositionTitle} <span class="dates">${item.Location} | ${formattedstartdate} - ${formattedenddate}</span></div>
                <ul class="skills"><li>${item.Description}</li></ul>
    ...
    projects.forEach(function (item) {
        if (item.ProjectName) {
            ...
            <div class="project-item">
                <div class="project-name"><b>${item.ProjectName} (${displayDateRange})</b></div>
                <ul class="skills">${item.ProjectDescription}</ul>
                <div class="clear"></div>
            </div>
        `;
    ...
    achievements.forEach(function (item) {
        if (item.AchievementTitle) {
            ...
            var achievementsHtml = `
                <p><strong>${item.AchievementTitle}</strong></p><b<r>
